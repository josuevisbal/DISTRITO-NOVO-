...
-- pegada— y cada uno toma lo que va a llevar desde su celular.
...
-- del cliente —el mismo que trae la cuenta pegada— y lo marca suyo. Si otro se le
-- adelantó, el `where` no encuentra nada y se le dice, en vez de quitárselo.
...
-- Caja se arrepiente, o el domiciliario tomó el que no era: el pedido vuelve al
-- mostrador y queda libre para que lo tome otro. Solo mientras NO lo haya recogido; si ya
-- salió con la comida, el camino es que él reporte "No pude entregar".
...
-- domiciliario: los pedidos que ya tomó, y los que están en el mostrador esperando que
-- alguien los lleve (en despacho y sin dueño). Nada de otros domiciliarios.
